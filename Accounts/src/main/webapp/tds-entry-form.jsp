		...
		<div class="col-md-10 mx-auto">
			<div class="card">
				<div class="card-header text-center c-head text-white">
					...
					<h5>Tax Deduction at Source (TDS) Information Entry</h5>
				</div>
				<div class="card-body">
					<form action="SaveNewTDSInfo" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-3">
								<label for="bankName">Bank Branch Name</label> <input
									name="bankName" type="text" class="form-control"
									id="bankName">
							</div>
							<div class="col-sm-3">
								<label for="tdsAmount">TDS Amount</label> <input
									name="tdsAmount" type="text" class="form-control"
									id="tdsAmount">
							</div>
						</div>
						<div class="form-group row">
